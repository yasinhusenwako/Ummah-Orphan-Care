...
const getTranslations = (lang: Language): Record<string, string> => {
  const translations: Record<Language, Record<string, string>> = {
    en: {
      ...
      'causes.howItWorksText': '100% of every Birr donation goes directly to our programs supporting Ethiopian children across all 12 regions. We maintain complete transparency with regular impact reports showing exactly how your contributions are transforming Ethiopian lives.',
    ...
    am: {
      ...
      'causes.howItWorksText': 'ከእያንዳንዱ ብር ልገሳ 100% በሁሉም 12 የኢትዮጵያ ክልሎች ህጻናትን በሚደግፉ ፕሮግራሞቻችን በቀጥታ ይሄዳል። አስተዋፅዖዎ የኢትዮጵያ ህይወትን እንዴት እንደሚለውጥ በትክክል የሚያሳዩ መደበኛ የተጽእኖ ሪፖርቶችን በመስጠት ሙሉ ግልጽነትን እንጠብቃለን።',
